  ...
  <div class="app-container">
    <el-form ref="form" :rules="rules" :model="form" status-icon label-position="right" label-width="80px">
      ...
      <div   v-if="form.orderPayAmount != 0"   >
        <span type="primary" disabled style="color:#409EFF;padding-left: 92px;">请继续完成信息，以提高贷款成功率</span>
        ...
        <el-form-item label="车产信息" prop="carType" label-width="120px" >
          <el-radio-group v-model="form.carType"  >
            ...
            <el-form-item label="" prop="carAddressType"  v-if="form.carType==1" >
        ...
        data() {
            return {
                form: {
                    ...
                    houseAddressType: '',
                    carType: '',
                    bussinessRegister: parseTime(new Date(), ''),
                    carAddressType: ''
                },
                rules: {
