<template>
  <div class="app-container">
    <el-card>
      <div>
        <el-input v-model="search.partnerId" style="width: 200px;" placeholder="合伙人编号" />
        <el-input v-model="search.partnerName" style="width: 200px;" placeholder="合伙人姓名" />
      ...
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" icon="el-icon-edit" @click="handleEdit(scope.row.partnerId)">编辑</el-button>
            <el-button v-if="scope.row.status==='00'" type="primary" size="mini" icon="el-icon-edit" @click="handleExa(scope.row.partnerId)">审核</el-button>
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleDel(scope.row.partnerId)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
