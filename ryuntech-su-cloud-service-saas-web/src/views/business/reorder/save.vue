  ...
  <el-dialog :title="dialogTitle" :before-close="handleClose" :visible.sync="dialogVisible" width="40%">
    <el-form ref="form" :rules="rules" :model="form" status-icon label-position="right" label-width="80px">
      ...
      <el-form-item label="客户名称" prop="memberName" label-width="120px">
        <el-input v-model="form.memberName" :disabled="true" placeholder="请输入客户名称" />
      </el-form-item>
      <el-form-item label="公司名称" prop="companyName" label-width="120px">
        <el-input v-model="form.companyName" placeholder="请输入公司名称" maxlength="60" />
      </el-form-item>
      ...
      <el-form-item label="贷款额度" prop="orderPayAmount" label-width="120px">
        <el-select v-model="form.orderPayAmount" placeholder="请选择贷款额度">
          <el-option label="请输入贷款额度" value="0" />
      ...
      <el-form-item label="实际到账金额" prop="orderFactPayAmount" label-width="120px">
        <el-input v-model="form.orderFactPayAmount" type="number" placeholder="请输入实际到账金额" />
      </el-form-item>

      <el-form-item label="营业执照号" prop="companyName" label-width="120px">
        <el-input v-model="form.idcartNumber" placeholder="请输入营业执照号" />
      </el-form-item>
      <el-form-item label="执照注册日期" prop="bussinessRegister" label-width="120px">
        <el-date-picker
          v-model="form.bussinessRegister"
          type="datetime"
          placeholder="选择日期时间"
      ...
      <el-form-item label="年纳税金额" prop="payTaxes" label-width="120px">
        <el-select v-model="form.payTaxes" placeholder="请选择年纳税额">
          <el-option label="请输入年纳税额" value="0" />
          <el-option label="1W-3W" value="1" />
          <el-option label="3W-5W" value="2" />
        </el-select>
      </el-form-item>

      <el-form-item label="年开发票金额" prop="annualInvoice" label-width="120px">
        <el-select v-model="form.annualInvoice" placeholder="请选择年开发票金额">
          <el-option label="请输入年开发票金额" value="0" />
          <el-option label="10W-30W" value="1" />
          <el-option label="30W-50W" value="2" />
        </el-select>
      </el-form-item>

      <el-form-item label="房产信息" prop="houseType" label-width="120px">
        <el-radio-group v-model="form.houseType">
          <el-radio label="按揭房" value="0" />
          <el-radio label="全款房" value="1" />
        </el-radio-group>
        <el-form-item v-if="form.houseType == '1'" label="" prop="houseAddressType">
          <el-radio-group v-model="form.houseAddressType">
            <el-radio label="本地房产" value="0" />
            <el-radio label="外地房产" value="1" />
          </el-radio-group>
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item label="车产信息" prop="carType" label-width="120px">
        <el-radio-group v-model="form.carType">
          <el-radio label="按揭车" value="0" />
          <el-radio label="全款车" value="1" />
        </el-radio-group>
        <el-form-item v-if="this.form.carType==1" label="" prop="carAddressType">
          <el-radio-group v-model="form.carAddressType">
            <el-radio label="本地车" value="0" />
            <el-radio label="外地车" value="1" />
          </el-radio-group>
        </el-form-item>
      </el-form-item>
      <el-form-item label="推荐码" prop="orderMemo" label-width="120px">
        <el-input v-model="form.referralCode" maxlength="10" placeholder="推荐码" />
      </el-form-item>
