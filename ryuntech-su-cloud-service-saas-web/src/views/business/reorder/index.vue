<template>
  <div class="app-container">
    <el-card>
      <div>
        <el-input v-model="search.orderid" style="width: 200px;" placeholder="请输入订单号查询" />
        <el-button style="margin-left: 10px;" type="success" icon="el-icon-search" @click="fetchData">查询</el-button>
        <el-button style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleSave">添加</el-button>
      </div>
      <br>

      <el-table v-loading="listLoading" border :data="list" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" icon="el-icon-edit" @click="handleEdit(scope.row.orderid)">编辑</el-button>
            <el-button v-if="scope.row.orderStatus==='01'" type="primary" size="mini" icon="el-icon-view" @click="handleLoan(scope.row.orderid)">放款</el-button>
            <el-button v-if="scope.row.orderStatus==='01'" type="danger" size="mini" icon="el-icon-view" @click="handleRefuse(scope.row.orderid)">拒款</el-button>
            <el-button v-if="scope.row.orderStatus==='05'" type="danger" size="mini" icon="el-icon-delete" @click="handleDel(scope.row.orderid)">删除</el-button>
