      ...
      <View className="userCenter">
        <View className="userInfo">
          <View className='at-row' >
            ...
            <View className='t-col at-col-1 at-col--auto' style="display: flex;align-items: center;justify-content: center;">
              <Text  style='font-size: 1.2rem;color: #FFFFFF;font-weight: 700;padding-left:10px'>{this.state.nickName}</Text>
            </View>
            <View className='t-col at-col-1 at-col--auto' style="display: flex;align-items: center;justify-content: center;margin-left:30px;">
             {/* <AtTag type='primary' circle
                     style='font-size: 1.2rem;color: #FFFFFF;font-weight: 700;'>
                <View>
                  <Image style="width: 15px;height: 15px;margin:5px;"   src={partner_01}>{this.state.status}</Image>
                </View>
              </AtTag>*/}
              {/*<View style="border-radius:5%;width: 100%;background-color: #ccc;">*/}
