...
var AtCheckbox = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtCheckbox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtCheckbox.__proto__ || Object.getPrototypeOf(AtCheckbox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray1", "rootCls", "options", "selectedList", "customStyle", "className"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AtCheckbox, [{
    ...
    value: function _createData() {
      ...
      var loopArray1 = options.map(function (option, idx) {
        option = {
  ...
  return AtCheckbox;
}(_component2.default), _class.$$events = ["handleClick"], _class.$$componentPath = "C:/Users/EDZ/IdeaProjects/ryuntech-su-cloud/ryuntech-su-partner-mini/node_modules/taro-ui/dist/weapp/components/checkbox/index", _temp2);
