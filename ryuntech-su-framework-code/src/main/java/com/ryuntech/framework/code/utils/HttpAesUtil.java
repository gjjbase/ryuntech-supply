...
package com.ryuntech.framework.code.utils;
...
public class HttpAesUtil {
	 ...
	 */
	public static String encrypt(String contentParam, String keyParam, boolean md5Key, String ivParam) throws Exception {
		try {
	 ...
	 * @return string
	 */
	public static String decrypt(String contentParam, String keyParam, boolean md5Key, String ivParam) throws Exception {
		try {
